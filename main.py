...
# Create a customer account. Linked by customer_id to the customer.
...
def view_customer_current_accounts(customer_name, customer_id, current_accounts):
    print("*****************************************")
    print(f"{customer_name} bank account list:")
...
# Checks if the account is active. Required to do before adding transactions
                    ...
                    while True:
                        ...
                        match cust_option:
                            ...
                            case "3":
                                ...
                                while True:
                                    # Editing the account. Select account, then call the update_current_account() method.
                            ...
                            case "5":
                                ...
                                if current_account in current_accounts:
                                    for key, val in current_accounts.items():
                                            view_transactions(current_account, transactions)
                                            break
                                else:
                                    print(f"Bank account ID: {current_account} does not exist!")
                                    break
